...
export const cloneCommand = `git clone https://github.com/ardifx01/ildisv4.git`;

<Code code={cloneCommand} lang="shell"/>

### Ekstrak Manual
Anda juga dapat mengunduh rilis terakhir ILDIS pada website <a href="https://github.com/ardifx01/ildis/releases" target="_blank">di sini</a>
...
git clone https://github.com/ardifx01/ildisv4.git
...
<Code code={`cd C:\\xampp\\htdocs\ngit clone https://github.com/ardifx01/ildisv4.git ildis`} lang="shell" />

Atau ekstrak file rilis dari [GitHub Releases](https://github.com/ardifx01/ildis/releases)
...
export const generateKey = `bash <(curl -s https://raw.githubusercontent.com/ardifx01/ildis-helper-scripts/refs/heads/main/generate_cookie_keys.sh)`;
export const generateKeyPowershell = `$phpScript = Invoke-RestMethod -Uri "https://raw.githubusercontent.com/ardifx01/ildis-helper-scripts/refs/heads/main/generate_cookie_keys.php"
php -r $phpScript`
